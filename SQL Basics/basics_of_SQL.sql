...
-- Query 4 : filtering - select the first and last name of the customers who come from Washington city
...
-- ORDER BY clause
/* Query 9: Return all the models of production type 'sooter' ordered by the 
production_end_date (new production should be at the top)*/
